#' SBM with multiple-try metropolis with ordinary(unscaled) weight function
...
#'
#' @examples
sbm_mtm_ord<- function(A, k =5, ntry = 10, z_init = NULL, N_iter=10000, a=1, b=1, 
  ...
  for (imcmc in 1:N_iter){
    ...
    logweights_star = log_lik_newstar
    
    accratio.denom = matrixStats::logSumExp(c(logweights_star,log_lik)) # log scale
